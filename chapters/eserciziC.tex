...
A questo punto definiamo $ (\Omega, \sigma, k) $ il prodotto diretto dei due gruppi di Lie appena definiti, \ie
...
\begin{tcolorbox}
	...
	e la restrizione di $ \pi $ a $ L $, \ie $ f = \pi_{|L} : L \to \S^{1} \times \S^{1} $. Siano
