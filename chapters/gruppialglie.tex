...
con la struttura differenziale ereditata da $ M_{n}(\R) = \R^{n^{2}} $ in quanto $ GL_{n}(\R) $ è aperto in questo spazio, è un gruppo di Lie rispetto alla moltiplicazione e l'inversione:
...
La traccia di una matrice a entrare reali è un numero reale, i.e. $ \tr(X) \in \R $, nonostante ci possano essere autovalori complessi, perché quest'ultimi saranno complessi coniugati tra loro e, sommandoli, si elidono a vicenda.
