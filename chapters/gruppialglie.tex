...
\subsubsection{$ U(n) $ come sottogruppo di Lie di $ GL_{n}(\C) $}
...
con $ \theta_{j} \in \R $ per $ j=1,\dots,n $. Possiamo definire una curva
...
\subsubsection{$ SU(n) $ come sottogruppo di Lie di $ U(n) $}
