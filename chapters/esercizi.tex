...
Prendendo un parametro $ k = 1,\dots,n+1 $, definiamo i $ 2(n+1) $ aperti
...
\begin{equation}
	D_{j} = \{ (x^{1},\dots,x^{j-1},x^{j+1},\dots,x^{n+1}) \in \R^{n} \mid \norm{x} < 1 \} = B_{1}(0) \simeq \R^{n} \qcomma j = 1,\dots,n+1
\end{equation}
