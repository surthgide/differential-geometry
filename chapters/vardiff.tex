...
\begin{proof}
	...
	L'ultimo passo è mostrare che $ \tilde{f} $ sia una bigezione\footnote{%
		Non possiamo utilizzare il lemma dell'applicazione chiusa perché altrimenti dovremmo utilizzare come assunzione che $ \rp{n} $ sia compatto, ma questo è la tesi della dimostrazione.%
	}: per fare ciò prendiamo la sua inversa

	\begin{align}
		\begin{split}
			\tilde{f}^{-1} : \sfrac{\S^{n}}{\sim_{a}} &\to \rp{n}\\
			[x]_{a} &\mapsto [x]
		\end{split}
	\end{align}
...
Se prendiamo $ n=1 $, $ \rp{1} \simeq \S^{1} $: si può identificare $ \S^{1} $ con l'intervallo $ I $ omeomorfo alla semicirconferenza quozientato i due punti estremi di quest'ultima $ \{A,B\} $, i.e. $ \S^{1} \simeq \sfrac{I}{\{A,B\}} $, in modo tale che si prenda solo uno dei due punti antipodali.
...
\begin{equation}
	\lambda V = \left\{ \lambda x \st x \in V \right\}
\end{equation}
