...
} lisce in un intorno di $ p $: un suo elemento è una classe di equivalenza $ [(f,U)] $ dove $ p \in U $ aperto per il quale vale la seguente relazione di equivalenza, i.e. due germi di funzioni appartengono alla stessa classe
