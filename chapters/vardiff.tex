...
%
Sia $ \mathfrak{U} = \{(U_{\alpha},\varphi_{\alpha})\} $ un atlante topologico di uno spazio $ M $, diremo che $ (V,\psi) $ carta di $ M $ è $ C^{\infty} $-compatibile con $ \mathfrak{U} $ se $ (V,\psi) $ è $ C^{\infty} $-compatibile con $ (U_{\alpha},\varphi_{\alpha}) $ per qualsiasi $ \alpha \in A $.
...
\begin{proof}[Dimostrazione (transitività tramite atlante)]
	...
	siano lisce. \\
	Prendiamo $ \sigma \circ \psi^{-1} $: questa è liscia se lo è in $ \psi(p) \in \psi(V \cap W) $ per qualsiasi $ p \in V \cap W $. \\
