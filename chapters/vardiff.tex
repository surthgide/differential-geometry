...
\begin{proof}
	...
	Per il corollario del teorema della funzione inversa, esiste un aperto $ U_{p} \in N $ tale che $ \left( U_{p},\eval{G}_{U_{p}} \right) $ sia una carta di $ N $ intorno a $ p $. Considerando la seguente intersezione
