...
\begin{remark}
	...
	} $ S $ di $ \R^{n} $ è determinato da $ a_{1},\dots,a_{k} $ vettori linearmente indipendenti di $ \R^{n} $, quindi da una matrice $ A = \bmqty{ a_{1} & \dots & a_{k} } \in M_{n,k}(\R^{n}) $ con $ \rank(A) = k $.
\end{remark}
...
Le altre applicazioni sono analoghe, perciò
...
\begin{equation}
	((\phi_{12})^{-1} \circ \phi_{12})([A]) = (\phi_{12})^{-1}(A_{34} (A_{12})^{-1}) = \left[ \mqty{ \id_{2 \times 2} \\ A_{34} (A_{12})^{-1} } \right] = \left[ \mqty{ A_{12} \\ A_{34} } \right] = [A]
\end{equation}
