...
\begin{theorem}
	...
	cioè, se $ M $ è una curva connessa, allora\footnote{%
		Con l'uguaglianza introdotta in questa implicazione, si intende che la varietà differenziabile è \textit{diffeomorfa}: il concetto di diffeomorfismo viene introdotto nella Sottosezione \ref{s-sec:diff}.%
	} è la retta reale $ \R $ oppure il cerchio unitario $ \S^{1} $.
\end{theorem}
