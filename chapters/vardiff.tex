...
\begin{remark}
	...
	} $ S $ di $ \R^{n} $ è determinato da $ k $ vettori $ \{a_{1},\dots,a_{k}\} $ linearmente indipendenti di $ \R^{n} $ o, alternativamente, da una matrice $ A = \bmqty{ a_{1} & \cdots & a_{k} } \in M_{n,k}(\R^{n}) $ di rango $ k $.
\end{remark}
