...
Esiste una bigezione naturale $ \eta $ tra $ T(U) $ e $ \R^{2n} $: prendendo $ v \in T_{p}(M) $ e sapendo che le derivate parziali rispetto a $ x^{i} $ in $ p $ generano lo spazio tangente, i.e.
